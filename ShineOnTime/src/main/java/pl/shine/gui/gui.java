...
public class gui extends JFrame {
	...
	public gui() {
		...
		// wykorzystanie TimeSlot.ListHour aby pobraæ datê oraz wylistowaæ
		// dostêpne godziny
		myButton_hours.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				// dodaæ textSelect albo coœ w tym stylu dla pól ju¿
				// zarezerwowanych
		...
		myButton_reservation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				boolean availability = DbAccess.checkDateAndHour(yearGUI, monthGUI, dayGUI, hourGUI);
